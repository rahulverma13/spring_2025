...
public class AssignmentsControl {
    private static final Logger logger = LoggerFactory.getLogger(AssignmentsControl.class);

    @Autowired
    private AssignmentsJPA assignmentRepo;
    ...
    public ResponseEntity<?> createAssignment(
        ...
        try {
            Assignments newAssignment = new Assignments(name, type, description, dueDate);
            Assignments savedAssignment = assignmentRepo.save(newAssignment);
    ...
    try {
        List<Assignments> assignments = assignmentRepo.findAll();
    ...
    public ResponseEntity<?> editAssignment(
        ...
        try {
            Assignments assignment = assignmentRepo.findByName(name);
            if (assignment != null) {
    ...
    public ResponseEntity<?> submitAssignment(
        ...
        try {
            Assignments assignment = assignmentRepo.findById(assignmentId)
